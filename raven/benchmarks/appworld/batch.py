...
def _run_one(task_id: str, k: int, port: int, args, out_dir: str) -> dict:
    ...
    try:
        ...
        pass
    cmd = [sys.executable, "-m", "raven.benchmarks.appworld.agent_cli",
...
def main(argv=None) -> int:
    ...
    servers = {pt: _start_server(pt, args.out_dir) for pt in ports}
    for pt in ports:
        ok = _wait_up(pt)
