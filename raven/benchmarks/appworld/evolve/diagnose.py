...
WHERE_CLASSES = {
    "appworld_prompt": "raven/benchmarks/appworld/agent_cli.py APPWORLD_PROMPT (the agent instruction text).",
    "exec_tool": "raven/benchmarks/appworld/tool.py AppWorldExecuteTool (execution / error-recovery behaviour).",
    "agent_hook_new": "a NEW lifecycle hook raven/agent/hook/<name>.py (runtime intervention: finalize/recovery/verify).",
    "agent_hook_wire": "raven/benchmarks/appworld/agent_cli.py hook wiring (construct the hook and pass it to AgentLoop, unconditionally).",
